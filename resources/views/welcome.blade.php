        ...
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 selection:bg-red-500 selection:text-white">
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                <div class="flex justify-center">
                    <svg height="80px" width="80px" version="1.1" id="_x35_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                ...
                <div class="flex justify-center">
                    <h1 style="text-emphasis: #54e71f">Tea Factory Limited</h1>
                </div>
                ...
                <div class="flex justify-center mt-16 px-0 sm:items-center sm:justify-between">
                    ...
                    <div class="ml-4 text-center text-sm text-gray-500 sm:text-right sm:ml-0">
                        <p> © <?php echo date ('Y'); ?> Tea Factory System </p>
                    </div>
                </div>
            </div>
        </div>
